// ---------------------------------------------------------------------------
// Just Wanna Leave — content data
// Illustrative figures for a prototype. Always verify with official sources.
// ---------------------------------------------------------------------------

window.JWL = window.JWL || {};

// --- Country cards -------------------------------------------------------
window.JWL.countries = [
  {
    code: "IT", flag: "🇮🇹", name: "Italy", hook: "pays your rent",
  ...
  {
    code: "DE", flag: "🇩🇪", name: "Germany", hook: "no tuition",
  ...
  {
    code: "JP", flag: "🇯🇵", name: "Japan", hook: "full stipend",
  ...
  {
    code: "NO", flag: "🇳🇴", name: "Norway", hook: "free for PhDs",
  ...
  {
    code: "FR", flag: "🇫🇷", name: "France", hook: "€170/yr tuition",
  ...
  {
    code: "TW", flag: "🇹🇼", name: "Taiwan", hook: "gov. scholarships",
...
// --- Italy regions: geometry + DSU data ----------------------------------
// tier: green = funds ~100% of eligible | amber = partial / lottery | red = high competition
// Figures are illustrative ranges for a prototype.
window.JWL.regions = [
